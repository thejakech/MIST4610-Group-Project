...
**Query 10:** lists the first and last name of the players who played the most rounds by descending order. By using the COUNT function by matches played then doing an inner join to return players with at least one match. Then
